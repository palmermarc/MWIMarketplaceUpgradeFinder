...
interface MarketplaceAnalyzerProps {
  ...
  onUpgradesFound?: (upgrades: UpgradeOpportunity[]) => void;
}
...
export function MarketplaceAnalyzer({ character, marketData, rawCharacterData, combatItems, onUpgradesFound }: MarketplaceAnalyzerProps) {
  ...
  const findUpgradeOpportunities = (data: MarketData, char: CharacterStats) => {
    ...
    const upgradeOpportunities = opportunities.slice(0, 10);
  ...
  return (
    <div className="w-full space-y-6">
      {/* Market Summary - Centered - HIDDEN */}
      <div className="max-w-4xl mx-auto" style={{ display: 'none' }}>
